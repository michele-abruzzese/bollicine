...
import java.net.URL;
public class NuovoIndirizzoAliasNonValido8Test {
    ...
    @Test
    public void nuovoIndirizzoAliasNonValido8() {
        ...
        driver.findElement(By.name("indirizzo")).sendKeys("Via Roma 14");
        driver.findElement(By.name("citta")).sendKeys("Milano");
        driver.findElement(By.name("cap")).sendKeys("20019");
        driver.findElement(By.name("provincia")).sendKeys("Milano");
        driver.findElement(By.name("alias")).sendKeys("c");
