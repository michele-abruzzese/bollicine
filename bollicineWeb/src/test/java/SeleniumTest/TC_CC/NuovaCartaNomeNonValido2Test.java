...
import java.net.URL;
public class NuovaCartaNomeNonValido2Test {
    ...
    @Test
    public void nuovaCartaNomeNonValido2() {
        ...
        driver.findElement(By.cssSelector("#myModalCt1 input:nth-child(3)")).sendKeys("m");
