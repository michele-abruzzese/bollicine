...
import java.net.URL;
public class NuovaCartaCognomeNonValido1Test {
    ...
    @Test
    public void nuovaCartaCognomeNonValido1() {
        ...
        driver.findElement(By.cssSelector("#myModalCt1 input:nth-child(2)")).sendKeys("r");
