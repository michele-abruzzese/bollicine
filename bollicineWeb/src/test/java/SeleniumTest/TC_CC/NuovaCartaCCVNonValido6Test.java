...
import java.net.URL;
public class NuovaCartaCCVNonValido6Test {
    ...
    @Test
    public void nuovaCartaCCVNonValido6() {
        ...
        driver.findElement(By.name("ccv")).click();
        driver.findElement(By.name("ccv")).sendKeys("12a");
