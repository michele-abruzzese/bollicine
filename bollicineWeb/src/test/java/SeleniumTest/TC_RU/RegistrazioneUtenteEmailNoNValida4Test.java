...
import java.net.URL;
public class RegistrazioneUtenteEmailNoNValida4Test {
    ...
    @Test
    public void registrazioneUtenteEmailNoNValida4() {
        ...
        driver.findElement(By.id("emailControl")).sendKeys("Email@ema.");
        {
