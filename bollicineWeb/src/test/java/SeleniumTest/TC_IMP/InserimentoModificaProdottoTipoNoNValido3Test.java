...
import java.net.URL;
public class InserimentoModificaProdottoTipoNoNValido3Test {
    ...
    @Test
    public void inserimentoModificaProdottoTipoNoNValido3() {
        ...
        String errorMsg=driver.findElement(By.id("tipo-error")).getText();
