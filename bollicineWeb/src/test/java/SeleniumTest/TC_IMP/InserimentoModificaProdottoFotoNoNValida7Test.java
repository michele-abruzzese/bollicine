...
import java.net.URL;
public class InserimentoModificaProdottoFotoNoNValida7Test {
    ...
    @Test
    public void inserimentoModificaProdottoFotoNoNValida7() {
        ...
        driver.findElement(By.name("prezzo")).sendKeys("10.50");
        ...
        String errorMsg=driver.findElement(By.id("talkPhoto-error")).getText();
